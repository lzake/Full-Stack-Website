/* ScrollMagic v1.2.2 | (c) 2014 Jan Paepke (@janpaepke) | license & info: http://janpaepke.github.io/ScrollMagic */ ! function (e) {
    "use strict";
    var t, n, r = e.define;
    "function" == typeof r && r.amd || (r = function (t, n, r) {
        for (var i, o = 0; o < n.length; o++) i = n[o], "jquery" === i && (i = "jQuery"), n[o] = e[i];
        e[t] = r.apply(e, n)
    }), r("ScrollMagic", ["jquery", "TweenMax", "TimelineMax"], function (e) {
        return t = function (t) {
            var r, s, c = "ScrollMagic",
                u = {
                    container: window,
                    vertical: !0,
                    globalSceneOptions: {},
                ...
                E = function () {
                    if (f.version = f.constructor.version, e.each(g, function (e) {
                        ...
                        }), g.container = e(g.container).first(), 0 === g.container.length) throw c + " init failed.";
                    w = !e.contains(document, g.container.get(0)), w || g.container.on("resize", function (e) {
                        e.stopPropagation()
                    }), m = g.vertical ? g.container.height() : g.container.width(), g.container.on("scroll resize", b), g.refreshInterval = parseInt(g.refreshInterval), g.refreshInterval > 0 && (s = window.setInterval(R, g.refreshInterval)), r = a(T)
                },
                F = function () {
            ...
            return this.addScene = function (t) {
                return e.isArray(t) ? e.each(t, function (e, t) {
                    f.addScene(t)
                }) : t instanceof n && (t.parent() != f ? t.addTo(f) : e.inArray(t, h) < 0 && (h.push(t), h = z(h), t.on("shift." + c + "_sort", function () {
                    h = z(h)
                ...
                if (e.isArray(t)) e.each(t, function (e, t) {
                    ...
                    var n = e.inArray(t, h);
                    n > -1 && (t.off("shift." + c + "_sort"), h.splice(n, 1), t.remove())
                }
                return f
                ...
                if (t instanceof n) t.parent() === f ? f.scrollTo(t.scrollOffset()) : log(2, "scrollTo(): The supplied scene does not belong to this controller. Scroll cancelled.", t);
                ...
                } else e.isFunction(t) ? S = t : S.call(g.container[0], t);
                return f
                ...
                return arguments.length ? (y != e && (y = !!e, f.updateScene(h, !0)), f) : y
            ...
            var r, a, l, c, u, f, g, h = {
                ...
                b = function () {
                    R(), v.on("change.internal", function (e) {
                        ...
                        C(), v.update(), ("AFTER" === m && "duration" === e.reason || "DURING" === m && 0 === w.duration) && A()
                ...
                C = function () {
                    E = {
                        start: F + w.offset
                    }, a && w.triggerElement && (E.start -= a.info("size") * v.triggerHook()), E.end = E.start + w.duration
                },
                D = function (e) {
                    if (r) {
                        var t = "duration";
                        z(t, r.call(v)) && !e && (v.trigger("change", {
                            what: t,
                            newval: w[t]
                        }), v.trigger("shift", {
                            reason: t
                ...
                x = function (t) {
                    ...
                    if (a && w.triggerElement) {
                        for (var r = e(w.triggerElement).first(), o = a.info(), s = i(o.container), l = o.vertical ? "top" : "left"; r.parent().data("ScrollMagicPinSpacer");) r = r.parent();
                        var c = i(r);
                ...
                A = function (e) {
                    if (c && a) {
                        ...
                        if (e || "DURING" !== m) {
                            ...
                            u.pushFollowers ? w.duration > 0 && ("AFTER" === m && 0 === parseFloat(u.spacer.css("padding-top")) ? r = !0 : "BEFORE" === m && 0 === parseFloat(u.spacer.css("padding-bottom")) && (r = !0)) : n[t.vertical ? "top" : "left"] = w.duration * y, c.css(n), r && (c.removeClass(u.pinnedClass), O())
                        } else {
                            "fixed" != c.css("position") && (c.css("position", "fixed"), O(), c.addClass(u.pinnedClass));
                            var o = i(u.spacer, !0),
                                s = w.reverse || 0 === w.duration ? t.scrollPos - E.start : Math.round(y * w.duration * 10) / 10;
                ...
                I = function () {
                    a && c && "DURING" === m && !a.info("isDocument") && A()
                },
                N = function () {
                    a && c && "DURING" === m && ((u.relSize.width || u.relSize.autoFullWidth) && e(window).width() != u.spacer.parent().width() || u.relSize.height && e(window).height() != u.spacer.parent().height()) && O()
                },
                k = function (e) {
                    a && c && "DURING" === m && !a.info("isDocument") && (e.preventDefault(), a.scrollTo(a.info("scrollPos") - (e.originalEvent.wheelDelta / 3 || 30 * -e.originalEvent.detail)))
                };
            return this.parent = function () {
                return a
            }, this.duration = function (t) {
                var n = "duration";
                return arguments.length ? (e.isFunction(t) || (r = void 0), z(n, t) && (v.trigger("change", {
                    what: n,
                    newval: w[n]
                }), v.trigger("shift", {
                    reason: n
                ...
                var e = w.offset;
                return a && (e += w.triggerElement ? F : a.info("size") * v.triggerHook()), e
                ...
                if (arguments.length) {
                    var t = !1,
                        ...
                        i = w.reverse || e >= y;
                    if (0 === w.duration ? (t = y != e, y = 1 > e && i ? 0 : 1, m = 0 === y ? "BEFORE" : "DURING") : 0 >= e && "BEFORE" !== m && i ? (y = 0, m = "BEFORE", t = !0) : e > 0 && 1 > e && i ? (y = e, m = "DURING", t = !0) : e >= 1 && "AFTER" !== m ? (y = 1, m = "AFTER", t = !0) : "DURING" !== m || i || A(), t) {
                        var o = {
                                progress: y,
                                state: m,
                                scrollDirection: r
                        ...
                        s && "DURING" !== n && (l("enter"), l("BEFORE" === n ? "start" : "end")), l("progress"), s && "DURING" !== m && (l("BEFORE" === m ? "start" : "end"), l("leave"))
                    }
                    return v
                }
                return y
                ...
                c.parent().show(), "0px" === a.width && i && s(o.display), !i && n.pushFollowers && (n.pushFollowers = !1);
                ...
                }, u.relSize.width && l.css("width", a.width), u.relSize.height && l.css("height", a.height), c.before(l).appendTo(l).css({
                    position: i ? "relative" : "absolute",
                    top: "auto",
                    left: "auto",
                    bottom: "auto",
                    right: "auto"
                }), (u.relSize.width || u.relSize.autoFullWidth) && c.css("box-sizing", "border-box"), e(window).on("scroll." + d + "_pin resize." + d + "_pin", I), c.on("mousewheel DOMMouseScroll", k), A(), v
            }, this.removePin = function (t) {
                return c && (t || !a ? (c.insertBefore(u.spacer).css(u.origStyle), u.spacer.remove()) : "DURING" === m && A(!0), e(window).off("scroll." + d + "_pin resize." + d + "_pin"), c.off("mousewheel DOMMouseScroll", k), c = void 0), v
                ...
                return e instanceof t && a != e && (a && a.removeScene(v), a = e, R(), D(!0), x(!0), C(), O(), a.info("container").on("resize." + d, function () {
                    N(), v.triggerHook() > 0 && v.trigger("shift", {
                        reason: "containerSize"
                    })
                }), e.addScene(v), v.update()), v
            }, this.enabled = function (e) {
                return arguments.length ? (S != e && (S = !!e, v.update(!0)), v) : S
    ...
    ! function (e) {
        var t, n = 0,
            r = ["ms", "moz", "webkit", "o"];
        for (t = 0; !a && t < r.length; ++t) console.log(r[t] + "RequestAnimationFrame"), a = e[r[t] + "RequestAnimationFrame"], l = e[r[t] + "CancelAnimationFrame"] || e[r[t] + "CancelRequestAnimationFrame"];
        a || (a = function (t) {
